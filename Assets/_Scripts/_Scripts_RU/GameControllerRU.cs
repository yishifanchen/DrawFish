...
public class GameControllerRU : MonoBehaviour {
    ...
    public void f_ButtonShow()//展示按钮
    {
        ...
        m_curFish=Instantiate(m_fishType[m_draw.m_fishTemplateCount], Config.m_showFishPos_RU, Quaternion.Euler(m_fishType[m_draw.m_fishTemplateCount].transform.rotation.eulerAngles.x, m_fishType[m_draw.m_fishTemplateCount].transform.rotation.eulerAngles.y-90, m_fishType[m_draw.m_fishTemplateCount].transform.rotation.eulerAngles.z))as GameObject;
